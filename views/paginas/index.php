...
<section class="resumen">
  <div class="resumen__grid">
    <div class="resumen__bloque"<?php aos_aniamcion(); ?>">
...
<section class="speakers">
  ...
  <?php foreach($ponentes as $ponente) { ?>
    <div <?php aos_aniamcion(); ?> class="speaker">
      <picture>
      ...
      <div class="speaker__informacion">
        ...
        <nav class="speaker-sociales">
          <?php $redes = json_decode($ponente->redes); ?> <!--Convierte el string en objeto -->
...
<section class="boletos">
  ...
  <div class="boletos__grid">
    <div <?php aos_aniamcion(); ?> class="boleto boleto--presencial">
      <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
      <p class="boleto__plan">Presencial</p>
      <p class="boleto__precio">$199</p>
    </div>

    <div <?php aos_aniamcion(); ?> class="boleto boleto--virtual">
      <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
      <p class="boleto__plan">Virtual</p>
      <p class="boleto__precio">$49</p>
    </div>

    <div <?php aos_aniamcion(); ?> class="boleto boleto--gratis">
      <h4 class="boleto__logo">&#60;DevWebCamp/></h4>
